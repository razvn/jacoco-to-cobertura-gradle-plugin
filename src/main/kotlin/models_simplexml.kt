...
class CoberturaSimpleXML {
    ...
    class Coverage(j: JacocoSimpleXML.Report, sources: Collection<String> = emptyList(), rootPackageToRemove: String? = null) : Counters() {
    ...
    class Package(p: JacocoSimpleXML.PackageElement, rootPackageToRemove: String? = null) : Counters() {
    ...
    class ClassElement(c: JacocoSimpleXML.ClassElement, jPack: JacocoSimpleXML.PackageElement, rootPackageToRemove: String? = null) : Counters() {
        @field:Attribute(name = "name", required = true)
    ...
    class Method(m: JacocoSimpleXML.MethodElement, jSource: String?, jPack: JacocoSimpleXML.PackageElement) : Counters() {
        @field:Attribute(name = "name", required = true)
    ...
    class Line(l: JacocoSimpleXML.Line) {
        ...
        @field:ElementList(name = "conditions", required = false, inline = true)
    ...
    companion object {
        fun linesForMethod(
            jMethod: JacocoSimpleXML.MethodElement,
            jPack: JacocoSimpleXML.PackageElement,
            jSource: String?
        ): List<JacocoSimpleXML.Line> {
            return if (jSource == null) emptyList()
            else {
                val currentMethodLine = jMethod.line ?: 0
                val sourceLines: List<JacocoSimpleXML.Line> = jPack.sourcefiles
...
fun JacocoSimpleXML.Report.print() {
    println(name)
    println(sessionInfos.map(JacocoSimpleXML.SessionInfo::id).joinToString(", "))
    packages.forEach {
