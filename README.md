...
[![Gradle Plugin Portal](https://img.shields.io/badge/Gradle-v1.0.0-blue.svg)](https://plugins.gradle.org/plugin/net.razvan.jacoco-to-cobertura)
...
plugins {
    jacoco
    id("net.razvan.jacoco-to-cobertura") version "1.0.0"
}
```
